      ...
      <div>
        {user ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <span>Hola, <strong>{user.username || user.name}</strong></span>
            <button
              onClick={handleLogout}
              style={{ padding: '0.4rem 0.8rem', cursor: 'pointer', borderRadius: '4px', border: 'none', backgroundColor: '#e74c3c', color: '#fff' }}
            >
              Cerrar Sesión
            </button>
          </div>
